...
describe("Words", function() {
  ...
  it("counts hyphenated words as single words", function() {
    var words = new Words("family : mom : dad : mother-in-law : father-in-law");
    var expectedCounts = {"family" : 1, "mom" : 1, "dad" : 1, "mother-in-law" : 1, "father-in-law" : 1};
    expect(words.count).toEqual(expectedCounts);
  });
